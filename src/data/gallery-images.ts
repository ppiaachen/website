...
export const images = shuffle([
  { src: halloween1, alt: "Halloween Party KMKI x PPI Aachen", eventUrl: "/events/2023/halloween-x-kmki" },
  { src: halloween2, alt: "Halloween Party KMKI x PPI Aachen", eventUrl: "/events/2023/halloween-x-kmki" },
  { src: halloween3, alt: "Halloween Party KMKI x PPI Aachen", eventUrl: "/events/2023/halloween-x-kmki" },
  { src: halloween4, alt: "Halloween Party KMKI x PPI Aachen", eventUrl: "/events/2023/halloween-x-kmki" },
  { src: halloween5, alt: "Halloween Party KMKI x PPI Aachen", eventUrl: "/events/2023/halloween-x-kmki" },
  { src: halloween6, alt: "Halloween Party KMKI x PPI Aachen", eventUrl: "/events/2023/halloween-x-kmki" },
  { src: welcoming1, alt: "Pesta Penjamboetan", eventUrl: "/events/2023/welcoming-party" },
  { src: welcoming2, alt: "Pesta Penjamboetan", eventUrl: "/events/2023/welcoming-party" },
  { src: welcoming3, alt: "Pesta Penjamboetan", eventUrl: "/events/2023/welcoming-party" },
  { src: welcoming4, alt: "Pesta Penjamboetan", eventUrl: "/events/2023/welcoming-party" },
  { src: welcoming5, alt: "Pesta Penjamboetan", eventUrl: "/events/2023/welcoming-party" },
  { src: welcoming6, alt: "Pesta Penjamboetan", eventUrl: "/events/2023/welcoming-party" },
